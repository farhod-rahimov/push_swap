...
void	ft_sort_stack_a_part2(t_sort *s, int k, int i)
{
	...
	if ((*s->head_stack_b) && ft_lstsize((t_list *)(*s->head_stack_b)) < 3)
	{
		if (ft_lstsize((t_list *)(*s->head_stack_b)) == 3)
			ft_sort_if_3_elements_b(s->head_stack_a, s->head_stack_b, 0);
		else if (ft_lstsize((t_list *)(*s->head_stack_b)) == 2)
			ft_sort_if_2_elements_b(s->head_stack_b, 0);
	}
		...
		t_stack **head_stack_b, int list_size, int sorted_a)
{
	...
	if (s.list_size == 2)
		s.sorted_a = ft_sort_if_2_elements_a(s.head_stack_a, \
										s.sorted_a);
	else if (s.list_size == 3)
		s.sorted_a = ft_sort_if_3_elements_a(s.head_stack_a, \
