...
int	ft_sort_if_3_elements_b(t_stack **head_stack_a, t_stack **head_stack_b, int sorted_a)
{
	...
	if (value_0 < value_1 && value_1 > value_2 && value_0 < value_2)
		case_1_b(head_stack_a, head_stack_b);
	else if (value_0 > value_1 && value_1 < value_2 && value_0 < value_2)
		case_2_b(head_stack_a, head_stack_b);
	else if (value_0 < value_1 && value_1 > value_2 && value_0 > value_2)
		case_3_b(head_stack_a, head_stack_b);
	else if (value_0 > value_1 && value_1 > value_2 && value_0 > value_2)
		case_4_b(head_stack_a, head_stack_b);
	else if (value_0 > value_1 && value_1 < value_2 && value_0 > value_2)
		case_5_b(head_stack_a, head_stack_b);
	return (sorted_a + 3);
}
