...
int	ft_sort_if_3_elements(t_stack **head_stack_a, t_stack **head_stack_b, int sorted_a)
{
	...
	if (value_0 < value_1 && value_1 > value_2 && value_0 < value_2)
		case_1(head_stack_a, head_stack_b, sorted_a);
	else if (value_0 > value_1 && value_1 < value_2 && value_0 < value_2)
		case_2(head_stack_a, head_stack_b, sorted_a);
	else if (value_0 < value_1 && value_1 > value_2 && value_0 > value_2)
		case_3(head_stack_a, head_stack_b, sorted_a);
	else if (value_0 > value_1 && value_1 > value_2 && value_0 > value_2)
		case_4(head_stack_a, head_stack_b, sorted_a);
	else if (value_0 > value_1 && value_1 < value_2 && value_0 > value_2)
		case_5(head_stack_a, head_stack_b, sorted_a);
	else if (value_0 < value_1 && value_1 < value_2 && value_0 < value_2)
		case_6(head_stack_a, head_stack_b, sorted_a);
	return (sorted_a + 3);
}
